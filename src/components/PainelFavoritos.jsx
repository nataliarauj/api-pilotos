...
const PainelFavoritos = ({ favoritos, removerDosFavoritos }) => {
  return (
    <div>
      <h2>Favoritos</h2>
      {favoritos.length === 0 ? (
        ...
        favoritos.map((piloto) => (
          <div key={piloto.driverId} style={{ marginBottom: "15px" }}>
            ...
            />
            <button onClick={() => removerDosFavoritos(piloto)} style={{ marginLeft: "10px", padding: "5px 10px", backgroundColor: "#f44336", color: "white", border: "none", borderRadius: "5px" }}>
